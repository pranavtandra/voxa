...
const routines = [
  {name:"School Morning",emoji:"🎒",phrases:["I need breakfast.","I need my backpack.","I'm ready to leave."]},
  {name:"Restaurant",emoji:"🍽️",phrases:["I would like to order.","Yes, please.","No, thank you.","I'm finished."]},
  {name:"Wind Down",emoji:"☾",phrases:["I need quiet.","I want my headphones.","I'm ready to rest."]},
];
...
export default function Home() {
  ...
  const [tts,setTts]=useLocal("voxa-tts",true); const [autoSpeak,setAutoSpeak]=useLocal("voxa-auto-speak",false); const [voiceName,setVoiceName]=useLocal("voxa-voice","");
  ...
  useEffect(()=>{if(localStorage.getItem("voxa-clean-seed-v1"))return;setPhrases(p=>p.filter(x=>!["p1","p2","p3"].includes(x.id)));setHistory(h=>h.filter(x=>![["10:42 AM","Could I have some water, please?"],["10:38 AM","It's too loud in here."]].some(([time,text])=>x.time===time&&x.text===text)));localStorage.setItem("voxa-clean-seed-v1","1")},[setPhrases,setHistory]);
